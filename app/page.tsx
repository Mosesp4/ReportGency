    ...
    <main className="relative px-6 pt-32">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="flex flex-col items-center text-center">
          ...
          Empowering safer communities with AI technology, <span className="bg-gradient-to-r from-sky-400 to-blue-500 bg-clip-text text-transparent">ReportGency</span> lets you report emergencies, crimes, and incidents like 
          fire outbreaks with ease. Your safety is our priority, with advanced encryption ensuring your identity stays anonymous 
          while connecting you to the right authorities. Making a difference has never been safer & simpler.
          </p>

          <div className="mt-10 flex flex-col sm:flex-row gap-4">
            <Link href={"/submitReport"}>
